...
console.log(`${chalk.yellow.bold('[ ⚠️ تم حذف الملف  ]')} ${chalk.greenBright(`'${file}'`)}\n` +
...
let descs = groupMetadata.desc || "☀️ RUKAIBOT-𝗠𝗗 🍦";
...
thumbnailUrl: pp, 
title: [wm, '🪐 تـطـويـر 𝑴𝑰𝑿🦋' + gt + ' 🪐', '🌤 centergatabot.gmail.com'].getRandom(),
