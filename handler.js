...
m.reply(`🚫 *انتـ/ـي محظور/ه , لايمكنك/ي استخدام اوامر بوت*\n📑 *سبب: ${user.messageSpam === 0 ? 'غير محدد ' : user.messageSpam}*\n⚠️ \`\`\`إذا كان هذا بوت حسابًا رسميًا ولديك دليل يدعم أن هذه الرسالة خطأ، فيمكنك تقديم قضيتك في :\`\`\`👉 *${ig}*\n👉 ${asistencia}`)
user.antispam++	
return
}
...
//this.reply(m.chat, `🪶 الخيار الأفضل`, m)
this.sendMessage(m.chat, {text: `🪶 الخيار الأفضل `,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' تـطـويـر 𝑴𝑰𝑿🦋', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🍬développe rukai bot🧁', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🎀développe rukai bot🎋', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' RUKAICOINS 🦋 مستعمل (ه) ')  
break
}}} catch (e) {
console.error(e)
} finally {
...
let emot = pickRandom(["🎀", "👒", "⚜️", "🩰", "🌑", "🌕", "🌟", "🪐", "📜", "🏮", "🔥", "❄️", "🌨", "💧", "🇩🇿", "💎", "💸", "🦦", "💍", "🐉", "🪽", "🐋", "🪸", "🕷", "🕸", "🌷", "⚘️", "🌺", "🌿", "🍂", "🌾", "🌤", "☄️", "🌪", "🍉", "🫐", "🍇", "🍎", "🍥", "🍩", "🍡", "🍮", "🍯", "🍦", "🍨", "🍧", "🍭", "🍬", "🍫", "🧁", "🍷", "🍸", "☕️", "🍹", "🧊", "⚽️", "🔮", "🥶", "😶‍🌫️", "😱", "😨", "😰", "😥", "😓", "🤗", "🤔", "🫣", "🤭", "🫢", "🫡", "🤫", "🫠", "🤥", "😶", "🫥", "😐", "🫤", "😑", "🫨", "😬", "🙄", "😯", "😦", "😧", "😮", "😲", "🥱", "😴", "🤤", "😪", "😮‍💨", "😵", "😵‍💫", "🤐", "🥴", "🤢", "🤮", "🤧", "😷", "🤒", "🤕", "🤑", "🤠", "😈", "👿", "👺", "🤡", "🧸", "👻", "😺", "😸", "😹", "😻", "😼", "😽", "🙀", "😿", "😾", "🫶", "👍", "✌️", "🙏", "🫵", "🤏", "🤌", "☝️", "🀄", "🙏", "🫵", "🫂", "🐱", "🤹‍♀️", "🤹‍♂️", "🗿", "✨", "⚡", "🔥", "🌈", "🩷", "❤️", "🧡", "💛", "💚", "🩵", "💙", "💜", "🖤", "🩶", "🤍", "🤎", "💔", "❤️‍🔥", "❤️‍🩹", "❣️", "💕", "💞", "💓", "💗", "💖", "💘", "💝", "🪻", "👊", "👀", "💋", "🫰", "💅", "👑", "🐣", "🐤", "🐈"])
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'تـطـويـر 𝑴𝑰𝑿🦋') :
...
"thumbnail": apii.data, 
"title": [wm, 'تـطـويـر 🪶 ' + gt + ' 🪻', '╰⊰⊹✿🇩🇿⊹⊱╮'].getRandom(),
