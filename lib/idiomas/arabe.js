const lenguaje = () => { return 'ar' } //معرب و مزخرف من طرف mix🍡

//الأشعارات
const smsAvisoRG = () => { return `╰⊰⊹✿النتيجة🪶✿⊹⊱╮\n\n` }
const smsAvisoAG = () => { return `╰⊰⊹✿تنبيه🦋✿⊹⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊰⊹✿معلومه☀️✿⊹⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊰⊹✿خطأ🪽✿⊹⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊰⊹✿عمل سئ🍡✿⊹⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊰⊹✿ابلاغ عن🎩✿⊹⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊰⊹✿النجاح🎶✿⊹⊱╮\n\n` }

//المعلمات في الأوامر
const smsRowner = () => { return `\`\`\`✿🜸𓂃هذا امر بي صفت مطوري يمكن استخذامه🪽🎶 ࣪˖\`\`\`` }
const smsOwner = () => { return `\`\`\`¡✿🜸𓂃هذا امر بي صفت مطوري يمكن استخذامه🪽🎶 ࣪˖\`\`\`` }
const smsMods = () => { return `\`\`\`✿🜸𓂃هذا امر فقط لي مطوري بوت🍡🦋 ࣪˖\`\`\`` }
const smsPremium = () => { return `\`\`\`✿🜸𓂃¡¡يتوفر هذا الأمر فقط للمستخدمين المتميزين ومنشئ المحتوى الخاص بي!! للحصول على قسط شراء تذكرة باستخدام #pass premium ࣪˖🧸\`\`\`` }
const smsGroup = () => { return `\`\`\`¡¡لا يمكن استخدام هذا الأمر إلا في مجموعات!!\`\`\`` }
const smsPrivate = () => { return `\`\`\`✿🜸𓂃هذا امر مخصص لي المجموعات فقط ࣪˖🍸\`\`\`` }
const smsAdmin = () => { return `\`\`\`✿🜸𓂃هذا امر يمكن ستخدامه فقط المشرفين مجموعه ࣪˖🍥\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`✿🜸𓂃انا اسف لايمكنني استخدام امر لأنني بحاجه الى اشراف ࣪˖🪐\`\`\`` }
const smsUnreg = () => { return `\`\`\`✿🜸𓂃انت لست مسجل في قائمه بوت ،لي تسجيل استخدم : .سجلني ࣪˖🌤\`\`\`` }
const smsRestrict = () => { return `\`\`\`✿🜸𓂃هذا امر مقفل من قبل مطوري ࣪˖✨️\`\`\`` }
...
const smsLista7 = () => { return `☀️ تثبيت RUKAIBOT🌤`}
...
//ترحيب و مغادره
const smsWelcome = () => { return `*∘₊✧─────⊰* @subject *⊱─────✧₊∘*\n*✿🪐 منور/ه*\n✿🍧 \`@user انا rukai_bot مسوؤله عن مجموعه\`\n *قوانين*\n*✿ممنوع سب*\n*✿ممنوع عنصريه و تنمر*\n✿اكتب \`.اوامر\` لكي تظهر اوامري\n*───── ꒰ა⋟﹏⋞໒꒱ ───── ✦*\n${String.fromCharCode(8206).repeat(850)}\n`}
const smsBye = () => { return '*𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ*\n┊ @user\n┊ *غادر المجموعة ، سيعود قريبًا* 🍡\n*𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ*'}
const smsSpromote = () => { return '*∘₊✧─────⊰🎶⊱─────✧₊∘*\n*✿@user اصبحت مشرفا *\n*∘₊✧─────⊰🦋⊱─────✧₊∘*'}
const smsSdemote = () => { return '*∘₊✧─────⊰☀️⊱─────✧₊∘*\n*@user لم تعد مشرفا في مجموعه🧸*\n*∘₊✧─────⊰🪽⊱─────✧₊∘*'}
const smsSdesc = () => { return '*∘₊✧─────⊰🍢⊱─────✧₊∘*\n*الوصف الجديد للمجموعة هو:*\n*∘₊✧─────⊰⛅️⊱─────✧₊∘*\n\n@desc'}
const smsSsubject = () => { return '*∘₊✧─────⊰🍦⊱─────✧₊∘*\n*الاسم الجديد للمجموعة هو:*\n*∘₊✧─────⊰🪡⊱─────✧₊∘*\n\n@subject'}
const smsSicon = () => { return '*∘₊✧─────⊰🌤⊱─────✧₊∘*\n*تم تغيير صورة هذه المجموعة!!*\n*∘₊✧─────⊰🪽⊱─────✧₊∘*'}
const smsSrevoke = () => { return '*∘₊✧─────⊰🦋⊱─────✧₊∘*\n*الآن هذا هو الرابط الجديد لهذه المجموعة!!*\n*∘₊✧─────⊰🪼⊱─────✧₊∘*\n\n*@revoke*'}
